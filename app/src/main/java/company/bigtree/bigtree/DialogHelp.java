...
public class DialogHelp {
    ...
    public static AlertDialog.Builder getReconnectConfirmDialog(Context context, String message, DialogInterface.OnClickListener onOkClickListener, DialogInterface.OnClickListener onCancleClickListener) {
        AlertDialog.Builder builder = getDialog(context);
        builder.setMessage(message);
        builder.setPositiveButton("是", onOkClickListener);
        builder.setNegativeButton("否", onCancleClickListener);
        return builder;
    }
